...
del %proname%.ihx
sdcc ..\..\%proname%.c --iram-size 256 --xram-size 1024 putchar.rel sys.rel uart.rel eeprom.rel -I %libpath%\StdDriver\inc\ -I %libpath%\Device\Include\
cd ..
del %proname%.hex
